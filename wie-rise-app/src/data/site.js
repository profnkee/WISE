export const SITE = {
  ...
  fullName: '1st IEEE Conference on WIE-RISE: Revolutionizing Innovation in Smart Engineering',
  organizer: 'Department of Electrical Engineering, National Institute of Technology (NIT) Jamshedpur',
  dates: 'April 01–03, 2027',
  targetDate: '2027-04-01T09:00:00',
  venueShort: 'NIT Jamshedpur, Jharkhand, India',
  venueAddress: 'NIT Campus, Adityapur, Jamshedpur, Seraikela-Kharsawan, Jharkhand – 831014',
  emails: {
...
export const NAV_LINKS = [
  ...
  { label: 'General Chair', to: '/general-chair' },
  {
    ...
    children: [
      ...
      { label: 'Technical Program Committee', to: '/technical-program-committee' },
    ],
  },
  {
    label: 'Authors',
