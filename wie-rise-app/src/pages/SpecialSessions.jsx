...
const WHY_PROPOSE = [
  {
    ...
    description: 'Highlight novel technologies and disruptive research directions.',
  },
  {
    title: 'Grow Communities',
    description: 'Connect organizers, authors, and reviewers around a shared focus.',
  },
  {
    title: 'Keep Reviews Rigorous',
    description: 'All session submissions go through the standard WIE-RISE review process.',
  },
]

const PROPOSAL_CHECKLIST = [
  { label: 'Session title', detail: 'a memorable and descriptive name.' },
  { label: 'Session overview', detail: '~100 words explaining the topic and its relevance.' },
  { label: 'Organizers', detail: '2–4 names with contact details and institutions.' },
  { label: 'Potential authors', detail: 'list contributors and affiliations.' },
  { label: 'Potential reviewers', detail: 'suggest at least 20 experts with affiliations.' },
]
      ...
      <Container className="py-16">
        <div className="grid gap-10 lg:grid-cols-2">
          <div className="space-y-5 text-justify leading-relaxed text-slate-600">
            <SectionHeading eyebrow="Special Sessions" title="Lead a High-Impact Session at WIE-RISE 2027" />
            <p>
              Create a focused forum for cutting-edge research and breakthrough applications in Electrical,
              Electronics and Computer Science. Build community, attract experts, and advance important new
              ideas.
            </p>
            <p>
              Special sessions highlight emerging areas that may not fit the main tracks, while offering a
              platform for targeted discussions and rapid knowledge exchange.
            </p>
          </div>
          <div className="grid gap-4">
            {WHY_PROPOSE.map((item) => (
              <div key={item.title} className="rounded-2xl border border-slate-200 p-5 shadow-sm">
        ...
        <div className="mt-16 grid gap-10 lg:grid-cols-2">
          <div className="space-y-5 text-justify leading-relaxed text-slate-600">
            <SectionHeading eyebrow="Overview" title="What is a Special Session?" />
            <p>
              Special sessions are designed to highlight high-focus programs in emerging or highly specialized
              areas. They extend the conference by offering a dedicated space for deeper technical exchange
              and cutting-edge discussion.
            </p>
          ...
          <div className="space-y-5 text-justify leading-relaxed text-slate-600">
            ...
            <p>
              Special Sessions broaden attendees' expertise by offering intensive technical programs for
              emerging fields. They are ideal for launching new collaborations, attracting contributors, and
        ...
        <div className="mt-16 grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <ul className="mt-6 space-y-3">
              {PROPOSAL_CHECKLIST.map((item, i) => (
                <li key={item.label} className="flex gap-3 rounded-xl border border-slate-200 p-4 text-sm text-slate-700">
                  <span className="shrink-0 font-display text-navy-300">{String(i + 1).padStart(2, '0')}</span>
                  <span>
                    <span className="font-semibold text-navy-950">{item.label}</span> — {item.detail}
                  </span>
                </li>
              ))}
            </ul>
          ...
          <div>
            <SectionHeading eyebrow="Policies" title="Organization & Policies" />
            <p className="mt-4 text-sm leading-relaxed text-slate-600">
              Organizers are responsible for promoting the session, coordinating review assignments, and
            ...
            <div className="mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-5">
              ...
              <p className="mt-1 text-sm leading-relaxed text-slate-600">
                Conflicts of interest must be declared before the review process begins. Any conflicted
                papers are handled independently by the Special Session chairs.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-slate-200 p-6 shadow-sm">
            <h3 className="font-display text-lg tracking-wide text-navy-950">Special Session Template</h3>
            <p className="mt-2 text-sm leading-relaxed text-slate-600">Will be provided soon.</p>
          </div>
